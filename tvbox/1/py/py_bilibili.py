...
class Spider(Spider):
    ...
    defaultConfig = {
        ...
        'raw_cookie_line': "b_nut=1660244823; buvid3=B63BF93B-67EE-410A-631C-054F0329CB7422986infoc; i-wanna-go-back=-1; DedeUserID=335281100; DedeUserID__ckMd5=93cb3fe66d606da5; buvid_fp=a6c8973fa1d12f7512b9dedcf87316f1; CURRENT_FNVAL=4048; rpdid=|(J|lmRk)Rm|0J'uY~uklJ)Jk; header_theme_version=CLOSE; LIVE_BUVID=AUTO1716793719312114; FEED_LIVE_VERSION=V8; buvid4=1E9B44AF-065D-0536-17DD-9E471DCF99C022986-022081203-NYTM3DGpvTOrMV/fM6STkQ==; _uuid=41F4A991-910F2-83E2-C53F-B9377A2B8F5C29399infoc; home_feed_column=4; enable_web_push=DISABLE; SESSDATA=e6aeae95,1717841676,05d62*c1CjDOgXe592lxTu0G9V5jNUx-Uf00VSRzyKzSk7zvR_KknRayur9JrrFJt9jHEOcZgwASVkhMMUR4dmxjSjEzTGFaaHJzUUZDSFpLa3l2dG9Pb3ZKTmh1eVliQ0V1RGdXNUR0Q212TGM1WE8zUFBXVkN5U1Y3aWkzVGdTeks2RlhvSDJBNlpIXzNRIIEC; bili_jct=fe317360fa02e3dcc81acb0ce1acb93e; sid=flrns70g; innersign=0; b_lsid=DC98EDAE_18C5EC755C8; bmg_af_switch=1; bmg_src_def_domain=i2.hdslb.com; browser_resolution=1280-577; bili_ticket=eyJhbGciOiJIUzI1NiIsImtpZCI6InMwMyIsInR5cCI6IkpXVCJ9.eyJleHAiOjE3MDI2NTY1MjEsImlhdCI6MTcwMjM5NzI2MSwicGx0IjotMX0.-JhoORcc-pBkiR5X1-32lDmq8-WSFOmx2YT4IfwYweU; bili_ticket_expires=1702656461",
