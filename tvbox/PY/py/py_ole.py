...
class Spider(Spider):
    ...
    def categoryContent(self,tid,pg,filter,extend):
        ...
        url = 'https://olevod1.com/index.php?do=categoryContent&tid={0}&page={1}&{2}'.format(tid, pg,params)
        rsp = self.fetch(url)
        alists = json.loads(rsp.text)
        alist = alists['list']
    ...
    def detailContent(self,array):
        tid = array[0]
        url = 'https://olevod1.com/index.php?do=detailContent&id={0}'.format(tid)
        rsp = self.fetch(url)
        alists = json.loads(rsp.text)
        vod = alists['vod']
        result = {
    ...
    def searchContent(self,key,quick):
        url = 'https://olevod1.com/index.php?do=searchContent&wd={0}'.format(key)
        rsp = self.fetch(url)
        alists = json.loads(rsp.text)
        list = alists['list']
        result = {
